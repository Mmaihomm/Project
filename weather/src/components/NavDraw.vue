  ...
  <nav absolute>
    ...
    >
      ...
      <v-card
        ...
        flat
        width="95%"
        class="mx-auto justify-center transparent"
        style="height: 100px; opacity:50% font-size: 24px;"
      >
      ...
      >
        ...
        <v-card dark flat class="transparent flex-column">
          <v-card
            ...
            flat
            width="95%"
            class="mx-auto d-flex justify-center transparent"
            style="margin: 2%; height: 100px; color:white;"
          >
            <v-card
              dark
              flat
              width="50%"
              class="mx-auto d-flex justify-center align-center transparent"
            >
          ...
          >
            ...
            <v-divider
              ...
              vertical
              inset
              style="border-width:2px; background-color:white; opacity:80%; margin:8px;"
            ></v-divider>
            <v-card
              dark
              flat
      ...
      >
        ...
        <v-card dark flat class="transparent flex-column"></v-card>
      </v-card>
    </v-card>
  </nav>
</template>
